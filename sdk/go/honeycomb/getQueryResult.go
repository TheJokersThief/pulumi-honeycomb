...
func (o GetQueryResultResultOutput) Results() pulumi.StringMapArrayOutput {
	return o.ApplyT(func(v GetQueryResultResult) []map[string]string { return v.Results }).(pulumi.StringMapArrayOutput)
}
