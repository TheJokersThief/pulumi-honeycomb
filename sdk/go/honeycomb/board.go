...
type Board struct {
	...
	BoardUrl pulumi.StringOutput `pulumi:"boardUrl"`
...
type boardState struct {
	// The URL to the board in the Honeycomb UI.
	BoardUrl *string `pulumi:"boardUrl"`
	// the number of columns to layout on the board, either `multi` (the default) or `single`. Only `visual` style boards (see below) have a column layout.
...
type BoardState struct {
	// The URL to the board in the Honeycomb UI.
	BoardUrl pulumi.StringPtrInput
	// the number of columns to layout on the board, either `multi` (the default) or `single`. Only `visual` style boards (see below) have a column layout.
...
// The URL to the board in the Honeycomb UI.
func (o BoardOutput) BoardUrl() pulumi.StringOutput {
	return o.ApplyT(func(v *Board) pulumi.StringOutput { return v.BoardUrl }).(pulumi.StringOutput)
}
