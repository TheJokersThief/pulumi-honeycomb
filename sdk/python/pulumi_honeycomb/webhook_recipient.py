...
__all__ = ['WebhookRecipientArgs', 'WebhookRecipient']

@pulumi.input_type
class WebhookRecipientArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] secret: The secret to include when sending the notification to the webhook.
        :param pulumi.Input[str] url: The URL of the endpoint to send the notification to.
        :param pulumi.Input[str] name: The name of the Webhook Integration to create.
        """
...
class WebhookRecipient(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WebhookRecipientArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WebhookRecipientArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WebhookRecipientArgs.__new__(WebhookRecipientArgs)
        ...
        super(WebhookRecipient, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            secret: Optional[pulumi.Input[str]] = None,
            url: Optional[pulumi.Input[str]] = None) -> 'WebhookRecipient':
        """
        ...
        __props__ = _WebhookRecipientState.__new__(_WebhookRecipientState)

        __props__.__dict__["name"] = name
        __props__.__dict__["secret"] = secret
        __props__.__dict__["url"] = url
        return WebhookRecipient(resource_name, opts=opts, __props__=__props__)
