...
class BoardArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] style: Deprecated: All Boards are now displayed as `visual` style. How the board should be displayed in the UI, either `visual` (the default) or `list`.
        """
        ...
        if style is not None:
            warnings.warn("""All Boards now are displayed visually in the UI. Setting this value will have no effect.""", DeprecationWarning)
            pulumi.log.warn("""style is deprecated: All Boards now are displayed visually in the UI. Setting this value will have no effect.""")
        if style is not None:
    ...
    @property
    @pulumi.getter
    @_utilities.deprecated("""All Boards now are displayed visually in the UI. Setting this value will have no effect.""")
...
class _BoardState:
    def __init__(__self__, *,
                 board_url: Optional[pulumi.Input[str]] = None,
                 column_layout: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 queries: Optional[pulumi.Input[Sequence[pulumi.Input['BoardQueryArgs']]]] = None,
        ...
        :param pulumi.Input[str] board_url: The URL to the board in the Honeycomb UI.
        :param pulumi.Input[str] column_layout: the number of columns to layout on the board, either `multi` (the default) or `single`. Only `visual` style boards (see below) have a column layout.
        :param pulumi.Input[str] description: Description of the board. Supports Markdown.
        :param pulumi.Input[str] name: Name of the board.
        :param pulumi.Input[Sequence[pulumi.Input['BoardQueryArgs']]] queries: Zero or more configurations blocks (described below) with the queries of the board.
        ...
        if board_url is not None:
            pulumi.set(__self__, "board_url", board_url)
        if column_layout is not None:
            pulumi.set(__self__, "column_layout", column_layout)
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    @property
    @pulumi.getter(name="boardUrl")
    def board_url(self) -> Optional[pulumi.Input[str]]:
        """
        The URL to the board in the Honeycomb UI.
        """
        return pulumi.get(self, "board_url")

    @board_url.setter
    def board_url(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "board_url", value)
...
class Board(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 queries: Optional[pulumi.Input[Sequence[pulumi.Input[Union['BoardQueryArgs', 'BoardQueryArgsDict']]]]] = None,
                 style: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ## # Resource: Board
        ...
        overview = honeycomb.Board("overview", queries=[{
        ...
        :param pulumi.Input[str] description: Description of the board. Supports Markdown.
        :param pulumi.Input[str] name: Name of the board.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BoardQueryArgs', 'BoardQueryArgsDict']]]] queries: Zero or more configurations blocks (described below) with the queries of the board.
        :param pulumi.Input[str] style: Deprecated: All Boards are now displayed as `visual` style. How the board should be displayed in the UI, either `visual` (the default) or `list`.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["board_url"] = None
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["board_url"] = board_url
        __props__.__dict__["column_layout"] = column_layout
        __props__.__dict__["description"] = description
        __props__.__dict__["name"] = name
        __props__.__dict__["queries"] = queries
    ...
    @property
    @pulumi.getter(name="boardUrl")
    def board_url(self) -> pulumi.Output[str]:
        """
        The URL to the board in the Honeycomb UI.
        """
        return pulumi.get(self, "board_url")
