...
def get_query_result(dataset: Optional[str] = None,
    ...
    :param str dataset: The dataset this query is associated with. Use `__all__` for Environment-wide queries.
    :param str query_json: A JSON object describing the query according to the Query Specification. While the JSON can be constructed manually, it is easiest to use the get_query_specification data source.
    """
    __args__ = dict()
    ...
    return AwaitableGetQueryResultResult(
        ...
        graph_image_url=pulumi.get(__ret__, 'graph_image_url'),
        id=pulumi.get(__ret__, 'id'),
        query_id=pulumi.get(__ret__, 'query_id'),
        query_json=pulumi.get(__ret__, 'query_json'),
