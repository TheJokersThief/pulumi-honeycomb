...
class ColumnArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] key_name: Please use `name` instead. The name of the column. Must be unique per dataset. Conficts with `name`.
        :param pulumi.Input[str] name: The name of the column. Must be unique per dataset.
        ...
        if key_name is not None:
            warnings.warn("""Please set `name` instead.""", DeprecationWarning)
            pulumi.log.warn("""key_name is deprecated: Please set `name` instead.""")
        if key_name is not None:
    ...
    @_utilities.deprecated("""Please set `name` instead.""")
