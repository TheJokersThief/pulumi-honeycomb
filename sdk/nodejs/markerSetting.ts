...
/**
 * ## # Resource: honeycomb.MarkerSetting
 *
...
export class MarkerSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'honeycomb:index/markerSetting:MarkerSetting';
    ...
    /**
     * The dataset this marker setting is placed on. Use `__all__` for Environment-wide marker settings.
     */
    ...
    constructor(name: string, argsOrState?: MarkerSettingArgs | MarkerSettingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MarkerSetting.__pulumiType, name, resourceInputs, opts);
    }
}
