...
/**
 * ## # Resource: honeycomb.DerivedColumn
 *
...
export class DerivedColumn extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'honeycomb:index/derivedColumn:DerivedColumn';
    ...
    constructor(name: string, argsOrState?: DerivedColumnArgs | DerivedColumnState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DerivedColumn.__pulumiType, name, resourceInputs, opts);
    }
}
