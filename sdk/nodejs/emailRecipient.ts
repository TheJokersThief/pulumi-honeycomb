...
/**
 * ## # Resource: honeycomb.EmailRecipient
 *
...
export class EmailRecipient extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'honeycomb:index/emailRecipient:EmailRecipient';
    ...
    constructor(name: string, argsOrState?: EmailRecipientArgs | EmailRecipientState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EmailRecipient.__pulumiType, name, resourceInputs, opts);
    }
}
