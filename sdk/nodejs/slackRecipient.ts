...
/**
 * ## # Resource: honeycomb.SlackRecipient
 *
...
export class SlackRecipient extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'honeycomb:index/slackRecipient:SlackRecipient';
    ...
    constructor(name: string, argsOrState?: SlackRecipientArgs | SlackRecipientState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SlackRecipient.__pulumiType, name, resourceInputs, opts);
    }
}
