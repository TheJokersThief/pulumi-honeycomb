...
export class ApiKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'honeycomb:index/apiKey:ApiKey';
     ...
     */
    public readonly permissions!: pulumi.Output<outputs.ApiKeyPermissions | undefined>;
    /**
...
export interface ApiKeyState {
     ...
     * A configuration block (described below) setting what actions the API key can perform.
     */
    permissions?: pulumi.Input<inputs.ApiKeyPermissions>;
    /**
     * The secret portion of the API Key.
     */
