...
SHELL            := /bin/bash
PACK             := honeycomb
PROJECT          := github.com/thejokersthief/pulumi-honeycomb
NODE_MODULE_NAME := @thejokersthief/${PACK}
TF_NAME          := ${PACK}
...
.PHONY: development provider build_sdks build_nodejs build_go build_python cleanup
